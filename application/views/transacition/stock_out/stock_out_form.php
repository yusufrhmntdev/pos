 ...
 <section class="content-header">
            <h1>
            Stock out
              <small>Barang Keluar / Rejected </small>
            </h1>
            <ol class="breadcrumb">
   ...
   <section class="content">
        ...
        <div class ="box">
            ...
            <h1 class="box-title">  Add Stock out</h1>
            <small> (Tambah barang masuk)</small>
                <div class="pull-right">
                    <a href="<?php echo site_url('stock/out');?>" class="btn btn-warning btn-flat btn-sm"><i class="fa fa-undo"></i> back</a>
                </div>
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="<?= site_url('stock/proses')?>" method="post" onsubmit="return validate(this);">
                    ...
                    <br>
                        ...
                        <div class="form-group">
                            <button class="btn btn-success btn-flat" type="submit" name="out_add">
...
function validate(form){
    ...
    if( qty > stock){
        ...
        error.innerHTML ="*Jumlah qty(kuantiti) tidak boleh melebihi stock, Stock tersedia hanya "+stock;
        error.style.color="#f00";
        return(false);

    } else if(qty < 1){
        error = document.getElementById("error");
        error.innerHTML ="Jumlah boleh melebihi 0 atau min";
        error.style.color="#f00";
        return(false);
    } else{
        return true;
